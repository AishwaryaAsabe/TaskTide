...
//         const token = localStorage.getItem('token');
//         try {
//             // Calculate the deadline based on selected bidding duration
//             const deadline = new Date();
//             deadline.setDate(deadline.getDate() + parseInt(newProject.biddingDuration)); // Ensure biddingDuration is used
    
//             const response = await axios.post('/api/projects', {
//                 title: newProject.title,
//                 description: newProject.description,
//                 budget: parseFloat(newProject.budget),
//                 biddingDuration: newProject.biddingDuration, // Send the duration (in days)
//                 biddingDeadline: deadline // Send the calculated deadline (in Date format)
//             }, {
//                 headers: {
//                     'Authorization': `Bearer ${token}`
//                 }
...
//             setProjects([...projects, response.data]);
//             setNewProject({ title: '', description: '', budget: '', biddingDuration: '' }); // Reset the form
//             toast.success('Project posted successfully!');
//         } catch (error) {
//             console.error('Error posting project:', error);
//             setError('Failed to post project');
...
//                 {/* Page Heading */}
//                 <div className="mb-10">
//                     <h1 className="text-3xl font-bold text-white text-center">Client Dashboard</h1>
...
//                         <h2 className="text-2xl font-semibold text-teal-400 mb-6">Post a New Project</h2>
//                         <form>
//                             <div className="mb-4">
...
//                             <div className="mb-4">
//     <label className="block text-sm font-medium text-gray-300">Bidding Duration (days)</label>
//     <input
//         type="number"
...
//         try {
//             const now = new Date();
//             const durationDays = parseInt(req.body.biddingDuration, 10);
//             const deadline = new Date(now.getTime() + durationDays * 24 * 60 * 60 * 1000); // Add days in milliseconds
    
//             const project = new Project({
//                 title: req.body.title,
//                 description: req.body.description,
//                 budget: req.body.budget,
//                 biddingDuration: req.body.biddingDuration,
//                 biddingDeadline: deadline.toISOString() // Save as ISO string
//             });
...
//                             <div
//                               key={bid._id}
//                               className="mt-2 p-3 bg-gray-700 rounded-lg shadow-inner border border-gray-600"
//                             >
//                               <p className="text-sm font-medium text-teal-400">
//                                 Freelancer:{" "}
//                                 {bid.freelancerId
